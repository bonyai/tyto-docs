---
title: Usage
description: Drive nests, sessions, files, previews, snapshots, and holds from Python
---
...
with nest.exec_tty(argv=["htop"]) as ws: ...
...
| `nest.exec_tty()` | Prepare a grant and run a one-off TTY command |
